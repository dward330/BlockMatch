...
import d.ward.blockmatch.models.Settings;
...
public class SettingsDBHelper extends SQLiteOpenHelper {
     ...
     * @return Settings
     */
    public d.ward.blockmatch.models.Settings getSettings() {
        d.ward.blockmatch.models.Settings settings = null;

        List<d.ward.blockmatch.models.Settings> setOfSettings = this.getAllSetsOfSettings();

        if (!setOfSettings.isEmpty()) {
            settings = setOfSettings.get(0);
        } else { // Save Default Settings, since non were found
            d.ward.blockmatch.models.Settings newSettings = new d.ward.blockmatch.models.Settings();
